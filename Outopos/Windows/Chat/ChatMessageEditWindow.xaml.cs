...
namespace Outopos.Windows
{
    ...
    partial class ChatMessageEditWindow : Window
    {
        ...
        public ChatMessageEditWindow(Chat chat, string content, IEnumerable<ChatMessage> responsMessages, DigitalSignature digitalSignature, bool isTrust, OutoposManager lairManager)
        {
            _chat = chat;
