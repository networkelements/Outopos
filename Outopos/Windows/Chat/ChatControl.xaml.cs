...
namespace Outopos.Windows
{
    ...
    partial class ChatControl : UserControl, IDisposable
    {
        ...
        public ChatControl(SectionTreeViewItem sectionTreeViewItem, ChatCategorizeTreeItem chatCategorizeTreeItem, OutoposManager lairManager, BufferManager bufferManager)
        {
        ...
        private void _chatCategorizeTreeViewItemCopyInfoMenuItem_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                sb.AppendLine(OutoposConverter.ToChatString(item.Value.Tag, null));
        ...
        private void _chatTreeItemTreeViewItemCopyInfoMenuItem_Click(object sender, RoutedEventArgs e)
        {
            ...
            sb.AppendLine(OutoposConverter.ToChatString(selectTreeViewItem.Value.Tag, null));
