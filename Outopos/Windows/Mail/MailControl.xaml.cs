...
namespace Outopos.Windows
{
    ...
    partial class MailControl : UserControl, IDisposable
    {
        ...
        public MailControl(SectionTreeViewItem sectionTreeViewItem, MailCategorizeTreeItem mailCategorizeTreeItem, OutoposManager lairManager, BufferManager bufferManager)
        {
