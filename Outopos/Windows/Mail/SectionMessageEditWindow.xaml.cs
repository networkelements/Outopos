...
namespace Outopos.Windows
{
    ...
    partial class SectionMessageEditWindow : Window
    {
        ...
        public SectionMessageEditWindow(L.Section section, string content, SectionMessage responsMessage, ExchangePublicKey exchangePublicKey, DigitalSignature digitalSignature, OutoposManager lairManager)
        {
            _section = section;
