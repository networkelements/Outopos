            ...
            foreach (var line in comment.Trim('\r', '\n').Split(new string[] { "\r\n", "\r", "\n" }, StringSplitOptions.None))
            {
                try
                {
                    ...
                    if (line.StartsWith("Section:"))
                    {
                        ...
                        var section = L.OutoposConverter.FromSectionString(line, out leaderSignature);
                    ...
                    else if (line.StartsWith("Wiki:"))
                    {
                        ...
                        var section = L.OutoposConverter.FromWikiString(line, out path);
                        if (section == null) continue;
                    ...
                    else if (line.StartsWith("Chat:"))
                    {
                        ...
                        var chat = L.OutoposConverter.FromChatString(line, out dummy);
            ...
            foreach (var line in comment.Trim('\r', '\n').Split(new string[] { "\r\n", "\r", "\n" }, StringSplitOptions.None))
            {
                try
                {
                    ...
                    else if (rl.StartsWith("Section:"))
                    {
                        ...
                        var section = L.OutoposConverter.FromSectionString(rl, out leaderSignature);
                    ...
                    else if (rl.StartsWith("Wiki:"))
                    {
                        ...
                        var wiki = L.OutoposConverter.FromWikiString(rl, out path);
                    ...
                    else if (rl.StartsWith("Chat:"))
                    {
                        ...
                        var chat = L.OutoposConverter.FromChatString(rl, out dummy);
