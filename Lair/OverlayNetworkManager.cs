...
namespace Lair
{
    class OverlayNetworkManager : StateManagerBase, Library.Configuration.ISettings, IThisLock
    {
        ...
        public OverlayNetworkManager(LairManager lairManager, BufferManager bufferManager)
        {
            ...
            _lairManager.CreateCapEvent = this.CreateCap;
            _lairManager.AcceptCapEvent = this.AcceptCap;
        }
