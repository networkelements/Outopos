...
namespace Lair.Windows
{
    ...
    {
        private Chat _chat;
        private List<Key> _anchors = new List<Key>();
        ...
        public MessageEditWindow(Chat chat, string content, IEnumerable<Key> anchors, DigitalSignature digitalSignature, LairManager lairManager)
        {
            _chat = chat;
            ...
            this.Title = string.Format(LanguagesManager.Instance.MessageEditWindow_Title, chat.Name);
        ...
        private void _okButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            _lairManager.UploadChatMessage(_chat, comment, _anchors, _digitalSignature);
