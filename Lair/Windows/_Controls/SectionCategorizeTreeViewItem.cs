...
{
    class SectionCategorizeTreeViewItem : TreeViewItem
    {
        ...
        public void Update()
        {
            ...
            foreach (var item in _value.Children)
            {
                ...
                {
                    _listViewItemCollection.Add(new SectionCategorizeTreeViewItem(item));
                }
            }
            ...
            foreach (var item in _value.SectionTreeItems)
            {
                ...
                {
                    _listViewItemCollection.Add(new SectionTreeViewItem(item));
                }
            }
